...
files = glob('../data/trainval/*/*_image.jpg')

# files = glob('/home/ruijie/Desktop/rob535_perception_yolov5/data/trainval/07fd6b85-0486-4790-ad35-a90a6b79c66c/0007_image.jpg')
files = glob('/home/ruijie/Desktop/rob535_perception_yolov5/data/trainval/06acf647-e2e9-4562-aa42-eed217e5bd84/0058_image.jpg')
# files = glob('/home/ruijie/Desktop/rob535_perception_yolov5/data/trainval/047b864f-0753-448b-9483-f990ae41abaf/0000_image.jpg')
files = glob("/home/ruijie/Desktop/rob535_perception_yolov5/data/trainval/53f2206c-7284-413b-86eb-bd9a86f279bb/0150_image.jpg")
...
for snapshot in files:
    ...
    for k, b in enumerate(bbox):
        ...
        c = classes[int(b[9])]
        print("b[]: {}; c: {}".format(b[9], classes[int(b[9])]))
